...
class googlenetmodel(nn.Module):
    def __init__(self,available_actions_count) -> None:
        ...
        self.model = torchvision.models.googlenet(weights = torchvision.models.GoogLeNet_Weights.DEFAULT)
...
class DQNAgent:
    def __init__(
        ...
        if load_model:
            ...
            self.q_net = googlenetmodel(action_size).to(DEVICE)
            self.target_net = googlenetmodel(action_size).to(DEVICE)
